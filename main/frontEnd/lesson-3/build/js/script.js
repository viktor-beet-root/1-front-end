...
/* harmony import */ var _products__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./products */ "./src/js/products.js");
/* harmony import */ var vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! vue/dist/vue.esm.browser */ "./node_modules/vue/dist/vue.esm.browser.js");
...
var pathImageFolder = './image/';
var currensySymbol = 'грн.';
var catalogVm = new vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_8__["default"]({
  el: '#catalog',
  data: {
  ...
  methods: {
    ...
    addToCart: function addToCart(product) {
      var productInCart = this.isCartProduct(product.id);
    ...
    isCartProduct: function isCartProduct(productId) {
      return cart.cartList.find(function (product) {
        return product.id === productId;
      });
    }
  },
  computed: {
    getInStocProducts: function getInStocProducts() {
...
var cart = new vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_8__["default"]({
  el: '#cart',
  data: {
    cartList: [],
    pathImageFolder: pathImageFolder,
  ...
  computed: {
    getCountProduct: function getCountProduct() {
    ...
    getTotalPrice: function getTotalPrice() {
      if (!this.cartList.length) return 0;
      return this.cartList.map(function (product) {
        return product.specialPrice * product.qty;
      }).reduce(function (sum, qty) {
        return sum + qty;
      }).toLocaleString();
    }
  ...
  methods: {
    setQtyProduct: function setQtyProduct(product, isIncrement) {
      if (isIncrement) {
        product.qty++;
      } else {
        if (product.qty < 2) {
    ...
    findProductIndex: function findProductIndex(productId) {
      return this.cartList.map(function (product) {
        return product.id;
      }).indexOf(productId);
    },
...
/***/ 0:
/*!*****************************************************!*\
  !*** multi ./src/js/products.js ./src/js/scrypt.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! D:\OpenServer\domains\1-front-end\main\frontEnd\lesson-3\src\js\products.js */"./src/js/products.js");
module.exports = __webpack_require__(/*! D:\OpenServer\domains\1-front-end\main\frontEnd\lesson-3\src\js\scrypt.js */"./src/js/scrypt.js");
