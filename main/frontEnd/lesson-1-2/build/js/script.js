...
var vm = new vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_3__["default"]({
  el: '#app',
  data: {
    message: 'Hello World',
    number: 542,
  ...
  computed: {
    ...
    infoUser: function infoUser() {
      return "<b>User Name</b>: ".concat(this.user.name, ". User Email: ").concat(this.user.email, ". User Tel: ").concat(this.user.tel);
    },
  ...
  methods: {
    ...
    incNumber: function incNumber(newNum, e) {
    ...
    clearAddUser: function clearAddUser() {
      this.addUser.name = '';
      this.addUser.tel = '';
      this.addUser.email = '';
      this.isValidate = false;
    },
    removeUser: function removeUser(indexUser) {
  ...
  beforeMount: function beforeMount() {//alert();
  }
});
var sss = new vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_3__["default"]({
  el: '#sss',
  data: {
    prim: "sdfsdfsdfsdf"
  },
