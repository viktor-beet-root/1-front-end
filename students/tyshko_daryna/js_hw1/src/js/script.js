...
//  //  2)   Запросите у пользователя год его рождения, посчитайте, сколько ему лет и выведите результат. Текущий год укажите в коде как константу.
 const thisYear = 2021;
 const userYear = +prompt('Введіть свій рік нaродження');
 const massageYear = "Вам " + (thisYear - userYear) + " роки.";

 console.log(massageYear); 

// // 3)   Запросите у пользователя длину стороны квадрата и выведите периметр такого квадрата.
 let sideSquare = prompt('Введіть довжину сторони квадрата');
 const squarePerimeter = 4 * sideSquare;
 const count = "Периметр квадрата = " + squarePerimeter;

 console.log(count);

//  4)   Запросите у пользователя радиус окружности и выведите площадь такой окружности.
let radius = prompt('Введіть радиус круга');
...
const time=prompt('Введіть час у годинах');

console.log(distance/time +' км/г');

//6) Реализуйте конвертор валют.Пользователь вводит доллары, программа переводит в евро.Курс валюты храните в константе.
const kurs = 0.82;
const dollars =prompt('Введіть сума в доларах');

console.log((dollars*kurs) +' Євро');
...
const volumeHb =prompt('Введіть об`єм флешки в Гб');
const mbFile = Math.floor((volumeHb*1024)/820);

console.log((mbFile) + ' файли');
...
const money =prompt('Введіть суму грошей на покупку');
const price =prompt('Введіть ціну шоколадки');

const buyAble=(money/price)-(money/price)%1;

const left =money-buyAble*price;

console.log('кількість шоколадок:'+buyAble);

console.log('залишок коштів:'+left);  
...
const userNum = +prompt('Введіть трьохзначне число');
...
const depositAmount = +prompt(' Введіть сумму депозиту?');
const yearProcent = 5;
const bankDays = 61;
