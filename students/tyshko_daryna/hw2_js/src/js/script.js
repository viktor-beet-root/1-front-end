...
const numberOne = ~~(numberUserFive / 10000);
const numberTwo = ~~(numberUserFive / 1000) % 10;
const numberThree = ~~(numberUserFive / 100) % 10;
const numberFour = ~~(numberUserFive / 10) % 10;
const numberFiva = numberUserFive % 10;
