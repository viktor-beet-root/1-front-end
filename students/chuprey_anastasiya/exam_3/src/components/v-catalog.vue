...
export default {
  ...
  data() {
    return {
      sliderItems: [
        { id: 1, name: "img1", img: "20.jpeg" },
        { id: 2, name: "img2", img: "21.jpeg" },
        { id: 3, name: "img3", img: "22.jpeg" },
        { id: 4, name: "img4", img: "23.jpeg" },
        { id: 5, name: "img5", img: "24.jpeg" },
      ],
    };
  },
