...
function number(firstNumber, secondNumer, thirdNumber) {
  ...
  var res = firstNumber * 100 + secondNumer * 10 + thirdNumber;
  return res;
}
...
;
var res = perfectNumber(+prompt('Введите число:'));
...
;
console.log(answerPerfectNumber(res)); // 6. Написать функцию, которая принимает минимальное и максимальное значения для диапазона, и выводит только те числа из диапазона, которые являются совершенными. Используйте написанную ранее функцию, чтобы узнавать, совершенное число или нет. 
