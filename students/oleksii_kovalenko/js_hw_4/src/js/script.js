...
function number(firstNumber, secondNumer, thirdNumber) {
    ...
    const result = (firstNumber * 100) + (secondNumer * 10) + thirdNumber;
...
let reqNumber = perfectNumber(+prompt('Введите число:'));
...
let answer = '';
    ...
    for (let j = Math.min(firstNumber, secondNumer); j < Math.max(firstNumber, secondNumer); j++) {
...
let enteredTime = takesTime(+prompt('Введите часы:'), +prompt('Введите минуты:'), +prompt('Введите секунды:'));
...
let timeDifferen;
const timeSec_1 = timeInSec(hh1, mm1, ss1);
const timeSec_2 = timeInSec(hh2, mm2, ss2);
...
let timeDiff = differenceTime(+prompt('Введите часы_1:'), +prompt('Введите минуты_1:'), +prompt('Введите секунды_1:'), +prompt('Введите часы_2:'), +prompt('Введите минуты_2:'), +prompt('Введите секунды_2:'));
