...
const enterTheNumber = +prompt("Введите трёхзначное число:");
let enterTheNumberMessage;
let number1 = Math.floor(enterTheNumber / 100);
let number2 = Math.floor(enterTheNumber / 10 % 10);
let number3 = enterTheNumber % 10;
...
if (number1 === number2 || number1 === number3 || number2 === number1 || number2 === number3) {
    ...
    enterTheNumberMessage = "В введёном трёхзначном числе нет одинаковых цифр.";

console.log(enterTheNumberMessage);
...
const enterYear = +prompt("Введите год:");
let yearMessage;
...
if (enterYear % 4 === 0 && enterYear % 100 !== 0 || enterYear % 400 === 0) {
    ...
    yearMessage = "Год " + enterYear + ", не высокосный.";

console.log(yearMessage);

//5) Запросить у пользователя пятиразрядное число и определить, является ли оно палиндромом.

const enterFiveNumber = +prompt("Введите пятиразрядное число: ");
let fiveNumber1 = Math.floor(enterFiveNumber / 10000);
let fiveNumber2 = Math.floor(enterFiveNumber / 1000) % 10;
let fiveNumber3 = Math.floor(enterFiveNumber / 100) % 10;
let fiveNumber4 = Math.floor(enterFiveNumber / 10) % 10;
let fiveNumber5 = enterFiveNumber % 10;
let fiveNumberMessage;
...
if (fiveNumber1 === fiveNumber5 && fiveNumber2 === fiveNumber4) {
    ...
    fiveNumberMessage = "Число не является полиндромом.";

console.log(fiveNumberMessage);
...
const usdConvert = prompt('Введите в какую валюту Вы хотите перевести USD: в EUR, в UAN или в AZN:');
let currencyConvert;

if (usdConvert === "EUR" || usdConvert === "eur" || usdConvert === "Eur" || usdConvert === "EUr" ||
    usdConvert === "euR" || usdConvert === "EuR" || usdConvert === "eUR" || usdConvert === "eUr") {
    currencyConvert = usd * 0.82;
} else if (usdConvert === "UAH" || usdConvert === "uah" || usdConvert === "Uah" || usdConvert === "UAr" ||
    usdConvert === "uaH" || usdConvert === "UaH" || usdConvert === "Uah" || usdConvert === "uAh") {
    currencyConvert = usd * 27.32;
} else if (usdConvert === "AZN" || usdConvert === "azn" || usdConvert === "Azn" || usdConvert === "AZn" ||
    usdConvert === "azN" || usdConvert === "AzN" || usdConvert === "aZN" || usdConvert === "aZn") {
    currencyConvert = usd * 1.70;
} else if (Number.isNaN(usd)) {
    currencyConvert =
        "Неправильный ввод данных, введите в какую валюту Вы хотите перевести USD: в EUR, в UAN или в AZN.";
} else
    currencyConvert =
    "Неправильный ввод данных, введите в какую валюту Вы хотите перевести USD: в EUR, в UAN или в AZN.";
...
const enterPurchaseAmount = +prompt('Введите сумму покупки:');
...
let сircumference = +prompt('Введите длину окружности:');
let perimeterOfSquare = +prompt('Введите периметр квадрата:');
let сircumferenceCalculate = сircumference / Math.PI;
let perimeterOfSquareCalculate = perimeterOfSquare / 4;
let messageCircumSquare;
...
console.log(messageCircumSquare);
...
const capital = +prompt('Назовите столицу Таиланда? Варианты ответов: 1 - Паттайя, 2 - Джакарта, 3 - Бангкок.');
const place = +prompt('Что за место, попав в которое, человек делает селфи на кухне, которую не может себе позволить? Варианты ответов: 1 - Лондон, 2 - Рим, 3 - Икея.');
const uncleDed = +prompt('Какой город объявлен официальной родиной русского Деда Мороза? Варианты ответов: 1 - Малая Вишера, 2 - Великий Устюг, 3 - Лапландия.');
let point = 0;
let errorMsg;
...
console.log('Количество набранных Вами баллов: ' + point);
