...
var reverse1 = number % 10;
var reverse2 = (number % 100 - number % 10) / 10;
var reverse3 = ~~(number / 100);
console.log(reverse1, reverse2, reverse3); // 10) Пользователь вводит сумму вклада в банк на 2 месяца, с процентной ставкой депозита 5% годовых. Вывести сумму начисленных процентов.
