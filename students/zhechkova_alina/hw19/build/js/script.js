...
function getHtml(info) {
  ...
  if (!info.total_results) {
    ...
    info.results.forEach(function (item, index) {
      newTag = "<div class=\"film-list\">\n                <h2>\n                    ".concat(index + 1, ". ").concat(item.title, "\n                </h2>\n                <p>\n                    Average vote: ").concat(item.vote_average, "\n                </p>\n                <small>\n                    Release date:").concat(item.release_date, "\n                </small>\n                <button type=\"button\" class=\"openOverview\">\n                    Details\n                </button>\n                <p class=\"film-overview\" id=\"text").concat(index, "\">\n                    ").concat(item.overview, "\n                </p>\n                \n            </div>");
      parentElem.insertAdjacentHTML('beforeend', newTag);
    });
  }
...
function openPreview() {
  var btn = document.querySelectorAll('.openOverview');
  btn.forEach(function (item, index) {
    item.addEventListener('click', function (e) {
      var p = document.querySelector("#text".concat(index));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _newAjax__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./newAjax */ "./src/js/lib/newAjax.js");


function getValue(e) {
  e.preventDefault();
  var url = "https://api.themoviedb.org/3/search/movie?api_key=ca7928216bf68cd760cad71e1df9e9d3&language=en-US&query=";
  var inputTitle = document.getElementById('inputTitle');
  var title = inputTitle.value;
  url += "".concat(encodeURIComponent(title), "&page=1&include_adult=false");
  Object(_newAjax__WEBPACK_IMPORTED_MODULE_0__["default"])(url);
  inputTitle.value = '';
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _getHtml__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getHtml */ "./src/js/lib/getHtml.js");
...
function newAjax(link) {
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
      Object(_getHtml__WEBPACK_IMPORTED_MODULE_0__["default"])(JSON.parse(xhr.responseText));
    }
  };
}

/* harmony default export */ __webpack_exports__["default"] = (newAjax);
...
/* harmony import */ var _lib_getValue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/getValue */ "./src/js/lib/getValue.js");
...
function getAjaxLink() {
  ...
  form.addEventListener('submit', _lib_getValue__WEBPACK_IMPORTED_MODULE_1__["default"].bind(this));
  ;
}
...
/***/ 0:
/*!*********************************************************************************************************!*\
  !*** multi ./src/js/script.js ./src/js/lib/getHtml.js ./src/js/lib/getValue.js ./src/js/lib/newAjax.js ***!
  \*********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\HP\Desktop\1-front-end\students\zhechkova_alina\hw19\src\js\script.js */"./src/js/script.js");
__webpack_require__(/*! C:\Users\HP\Desktop\1-front-end\students\zhechkova_alina\hw19\src\js\lib\getHtml.js */"./src/js/lib/getHtml.js");
__webpack_require__(/*! C:\Users\HP\Desktop\1-front-end\students\zhechkova_alina\hw19\src\js\lib\getValue.js */"./src/js/lib/getValue.js");
module.exports = __webpack_require__(/*! C:\Users\HP\Desktop\1-front-end\students\zhechkova_alina\hw19\src\js\lib\newAjax.js */"./src/js/lib/newAjax.js");
